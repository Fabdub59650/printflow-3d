...
- **Stats impressions** — nouvel onglet "Impressions" dans les Statistiques : durée estimée vs réelle (graphique barres + tableau écarts colorés), taux de réussite par imprimante et par filament avec barres de progression

### Corrigé
- logAction manquant dans routes filaments, impressions, imprimantes et bibliothèque (historique incomplet)
- restoreUpload non défini au démarrage (multer/os déclarés au niveau global dans backup.js)
